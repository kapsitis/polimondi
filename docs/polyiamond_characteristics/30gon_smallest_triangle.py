...
# Call get_smallest_triangle function
tri_vertices = p.get_smallest_triangle()
...
plt.savefig('30gon_smallest_triangle.svg', format='svg', bbox_inches='tight', transparent=True, pad_inches=0.1)

# Remove hardcoded width and height from the generated SVG
with open('30gon_smallest_triangle.svg', 'r') as f:
    svg_content = f.read()

import re
svg_content = re.sub(r'width="[0-9.]+pt" height="[0-9.]+pt" ', '', svg_content)

with open('30gon_smallest_triangle.svg', 'w') as f:
    f.write(svg_content)

print("Saved 30gon_smallest_triangle.svg")
